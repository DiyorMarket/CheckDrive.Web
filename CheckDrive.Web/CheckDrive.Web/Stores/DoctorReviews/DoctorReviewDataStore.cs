...
namespace CheckDrive.Web.Stores.DoctorReviews
{
    public class DoctorReviewDataStore : IDoctorReviewDataStore
    {
        ...
        public async Task<DoctorReviewDto> GetDoctorByIdAsync(int id)
        {
        ...
        public async Task<DoctorReviewDto> CreateDoctorAsync(DoctorReviewForCreateDto doctorReviewForCreate)
        {
